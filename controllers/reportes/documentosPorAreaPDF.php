...
foreach ($response['data'] as $documento) {
    $pdf->Row(array(
        ...
        $documento['estadoRecepcion'] == 'a' ? 'Recepcionado' : 'Pendiente de Recepción'
    ), 3);
}
...
//        $numDocumento,
//        'Tipo Documento',
//        'Asunto asunto asunto asunto asunto asunto asunto asunto asunto' ,
//        'Folios',
//        mb_convert_encoding('Larri Rodrigo Estrada León','ISO-8859-1', 'UTF-8'),
//        'Subgerencia de informatica y Sistemas',
//        'Seguimiento finalizado',
//        'Recepcionado'
//    ), 3);
//
////    $pdf->Cell(15, 8, $i, 1, 0, 'C', 1);
////    $pdf->Cell(30, 8, 'Tipo Documento', 1, 0, 'C', 1);
////    $pdf->Cell(40, 8, 'Asunto asunto asunto asunto asunto asunto asunto asunto asunto', 1, 0, 'C', 1);
////    $pdf->Cell(15, 8, 'Folios', 1, 0, 'C', 1);
////    $pdf->Cell(35, 8, 'Usuario', 1, 0, 'C', 1);
////    $pdf->Cell(35, 8, 'Area', 1, 0, 'C', 1);
////    $pdf->Cell(30, 8, 'Estado Documento', 1, 0, 'C', 1);
////    $pdf->Cell(30, 8, 'Estado Envio', 1, 1, 'C', 1);
//}
