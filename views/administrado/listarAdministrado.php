<div class="containerPendientesRecepcion">
    ...
    <div class="pendientesRecepcion_body">
        <table>
            ...
            <tbody>
            <?php foreach ($listadoAdministrado as $result):?>
                <!--            --><?php //var_dump($result); ?>
                <tr>
                    ...
                    <td class="actions">
                        <a class="action" href="<?=base_url?>administrado/editar?cod=<?=$result["codAdministrado"]?>">
                        ...
                        <div class="action" onclick="modalConfirmarRecepcion(<?=$result["codAdministrado"]?>)">
