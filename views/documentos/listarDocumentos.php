...
<div class="containerPendientesRecepcion">
        ...
        <div class="description_btnNuevoDocumento">
            <div>
                <p>Listado de Documentos</p>
                    <form action="<?= base_url ?>documento/listar" method="get">
                        <div class="containerFiltrado">
                            <div class="busqueda">
                                ...
                                <input
                                        type="text"
                                        name="numDoc"
                                        value="<?= isset($_GET['numDoc']) ? $_GET['numDoc'] : ''?>"
                                        autocomplete="off"
            ...
            <a href="<?=base_url?>documento/crear" class="btnNuevoDocumento">
    ...
    <div class="listadoDocumentos_body">
        <table>
            ...
            <tbody>
            <?php if (isset($_GET['numDoc']) && count($response['data']) == 0):?>
                <tr>
                    <td colspan="10" class="mensajeSinRegistros"> No existe el documento buscado o no tiene acceso a este </td>
                </tr>
            <?php elseif (count($response['data']) == 0): ?>
                <tr>
              ...
              <?php foreach ($response['data'] as $result):?>
                ...
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <?php if ($result['estado'] == 'a' && trim($_SESSION['user']['rol']) == 'administrador'):?>
                        ...
                        <?php if ($result['estado'] == 'i' && trim($_SESSION['user']['rol']) == 'administrador'):?>
