...
?>
<div class="modalConfirmar modals">
    <div class="header">
    ...
    <div class="body">
        <p class="mensaje">¿Desea confirmar que recepcionó físicamente el documento?</p>
        <form action="<?=base_url?>recepcion/confirmarRecepcion" method="post">
            <input type="hidden" id="codRecepcion" name="codRecepcion">
            <input type="submit" value="Sí">
            <input type="button" value="No" onclick=cerrar()>
        </form>
    </div>
</div>