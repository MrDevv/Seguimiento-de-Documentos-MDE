...
<div class="containerPendientesRecepcion">
    ...
    <div class="d-flex justify-content-between m-2">
        <div>
            <p class="fs-6">Total de registros:  <span class="fw-bold" id="totalDocumentosPendientesRecepcion"></span></p>
        </div>
        <div>
            <ul class="listadoOpcionesPaginacion" id="opcionesPaginacionDocumentosPendientesRecepcion">
            </ul>
        </div>
    </div>
</div>
