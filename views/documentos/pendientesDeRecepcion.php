...
<div class="containerPendientesRecepcion">
    ...
    <div class="pendientesRecepcion_body">
        <table>
            ...
            <tbody>
            <?php foreach ($resultsPendientesRecepcion as $result): ?>
                <tr>
                    <td> <?= $result["NUMERO DE DOCUMENTO"] ?> </td>
                    <td> <?= $result["FOLIOS"] ?> </td>
                    <td> <?= $result["TIPO DOCUMENTO"] ?> </td>
                    <td> <?= $result["AREA ORIGEN"] ?> </td>
                    <td> <?= $result["ADMINISTRADO ORIGEN"] ?> </td>
                    <td> <?= $result["FECHA DERIVACION"] ?> </td>
                    <td> <?= $result["OBSERVACION"] ?> </td>
                    <td> <span>Pendiente de Recepcion</span> </td>
                    <td class="actions">
                        <div class="action" onclick="modalConfirmarRecepcion(<?= $result["NUMERO DE DOCUMENTO"];?>)">
