...
<div class="containerRecepcionados">
    ...
    <div class="d-flex justify-content-between m-2">
        <div>
            <p class="fs-6">Total de registros:  <span class="fw-bold" id="totalDocumentosRecepcionados"></span></p>
        </div>
        <div>
            <ul class="listadoOpcionesPaginacion" id="opcionesPaginacionDocumentosRecepcionados">
            </ul>
        </div>
    </div>
</div>
