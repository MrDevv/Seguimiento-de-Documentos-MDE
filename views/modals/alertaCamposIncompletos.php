<div class="modalCamposIncompletos modals">
    <div class="header">
    ...
    <div class="body">
        <form action="<?php echo base_url;?>modals/cerrarModal">" method="post">
            <p class="mensaje">Campos incompletos, por favor ingrese todos los campos requeridos.</p>
