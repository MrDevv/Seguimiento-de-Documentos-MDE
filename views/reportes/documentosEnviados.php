...
<div class="containerRecepcionados">
        ...
        <div class="containerFiltrado">
            <div class="d-flex gap-2">
                <div class="busqueda">
                    ...
                    <input
                        id="numDocumentoReporteEnviados"
                        type="text"
                        name="numDocumento"
                        autocomplete="off"
                ...
                <div class="d-flex gap-1 align-items-center fechaFiltroReporte">
                    ...
                    <input class="m-0" type="date" id="fechaInicioReporteEnviados">
                </div>
                <div class="d-flex gap-1 align-items-center fechaFiltroReporte">
                    <label>Fecha Fin: </label>
                    <input class="m-0" type="date" id="fechaFinReporteEnviados">
                </div>
                <a href="#" class="btnFiltrarReportes" id="filtrarPorDocumentosEnviadosReporte">Filtrar</a>
            </div>
            <div>
                <a href="#" id="btnReporteDocEnviadosPdf" class="w-100 rounded-2 p-2 bg-white d-flex justify-content-center align-items-center" >
    ...
    <div class="recepcionados_body">
        <table>
            ...
            <tbody id="bodyEnviadosReporte">
            </tbody>
        </table>
    </div>
    <div class="d-flex justify-content-between m-2">
        <div>
            <p class="fs-6">Total de registros:  <span class="fw-bold" id="totalDocumentosEnviadosReporte"></span></p>
        </div>
        <div>
...
<script src="<?= base_url?>ajax/documentosEnviadosReporte.js"></script>
<script src="<?= base_url?>ajax/detalle.js"></script>
<script src="<?= base_url?>ajax/reporteDocEnviadosPDF.js"></script>
