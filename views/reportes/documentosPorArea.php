            ...
            <div class="fecha_busqueda">
                <div>
                    ...
                    <div class="busqueda">
                        ...
                        <input type="text" name="numDocumento" value="<?= isset($_GET['numDocumento']) ? $_GET['numDocumento'] : ''?>" placeholder="Número de Documento">
                    </div>
                </div>
            ...
            <?php else: ?>
                <?php foreach ($response['data'] as $result):?>
                    <tr>
                        ...
                        <span
                                class="estado
                                    <?php if ($result["estadoDocumento"] == 'a'): ?>
                                        <?= 'follow' ?>
                                    <?php elseif($result["estadoDocumento"] == 'i'): ?>
                                        <?=  'finished' ?>
                                    <?php endif; ?>
                                "
                        >
                        ...
                        <span
                                class="estado
                                    <?php if ($result["estadoRecepcion"] == 'a'): ?>
                                        <?= 'recepcionado' ?>
                                    <?php elseif($result["estadoRecepcion"] == 'i'): ?>
                                        <?=  'pendienteRecepcion' ?>
                                    <?php endif; ?>
                                "
                        >
