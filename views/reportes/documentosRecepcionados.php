...
<div class="containerRecepcionados">
        ...
        <div class="containerFiltrado">
            <div class="d-flex gap-2">
                <div class="busqueda">
                    ...
                    <input
                            id="numDocumentoReporteRecepcionados"
                            type="text"
                            name="numDocumento"
                            autocomplete="off"
                ...
                <div class="d-flex gap-1 align-items-center fechaFiltroReporte">
                    ...
                    <input class="m-0" type="date" id="fechaInicioReporteRecepcionados">
                </div>
                <div class="d-flex gap-1 align-items-center fechaFiltroReporte">
                    <label>Fecha Fin: </label>
                    <input class="m-0" type="date" id="fechaFinReporteRecepcionados">
                </div>
                <a href="#" class="btnFiltrarReportes" id="filtrarPorDocumentosRecepcionadosReporte">Filtrar</a>
            </div>
            <div>
                <a href="#" id="btnReporteDocRecepcionadosPdf" class="w-100 rounded-2 p-2 bg-white d-flex justify-content-center align-items-center" >
    ...
    <div class="d-flex justify-content-between m-2">
        <div>
            <p class="fs-6">Total de registros:  <span class="fw-bold" id="totalDocumentosRecepcionadosReporte"></span></p>
        </div>
        <div>
            <ul class="listadoOpcionesPaginacion" id="opcionesPaginacionDocumentosRecepcionadosReporte">
            </ul>
        </div>
    </div>
</div>
